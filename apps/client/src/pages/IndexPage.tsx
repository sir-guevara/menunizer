            ...
            <div className="col-md-12">
              <div className="idea__main_content ptb_2">
                <div className="idea__main_content_left" data-aos="fade-right">
                  <p>
                    Menunizer is the ideal tool for restaurants, bars and cafes.
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="need_header text-center" data-aos="fade-up">
                <h3>
                  Don't Think Twice! <span>You Need Menunizer 😎</span>
                </h3>
              </div>
            ...
            <div className="col-md-12">
              <div className="footer__content">
                ...
                <div className="footer__copyrigt_menu">
                  <p>
                    Copyright © {new Date().getFullYear()} Men<span>un</span>
                    izer.
                  </p>
                  <ul>
                    <li>
